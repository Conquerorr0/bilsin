...
class Department {
  ...
  factory Department.fromFirestore(Map<String, dynamic> data) {
    return Department(
      ...
      color: _colorFromInt(data['color'] ?? Colors.blue.value),
    );
  }

  static Color _colorFromInt(int colorValue) {
  ...
  static final List<Color> defaultColors = [
    ...
    const Color(0xFF553C9A), // İndigo
    const Color(0xFFD53F8C), // Pembe
    const Color(0xFF0891B2), // Cyan
    const Color(0xFFD69E2E), // Amber
    const Color(0xFFE24D28), // Deep Orange
    const Color(0xFF3182CE), // Light Blue
  ...
  // Statik bölüm listesi (Cloud Functions'dan senkronize edilecek)
  static List<Department> get allDepartments {
    final departments = [
      {
